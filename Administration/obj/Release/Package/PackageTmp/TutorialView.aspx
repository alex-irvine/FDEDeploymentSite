        ...
        <LayoutTemplate>
            ...
            <div runat="server" style="width: 100%" class="table table-hover">
                    ...
                    <div class="News_option">
                        <asp:LinkButton runat="server" OnClick="PublishClick" CssClass="btn btn-lg btn-success">Publish</asp:LinkButton>
                        <asp:LinkButton runat="server" OnClick="UnPublishClick" CssClass="btn btn-lg btn-warning">Unpublish</span></asp:LinkButton>
                        <asp:LinkButton runat="server" OnClick="DeleteClick" CssClass="btn btn-lg btn-danger">Delete</span></asp:LinkButton>
