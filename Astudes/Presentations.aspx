<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Presentations.aspx.cs" Inherits="Astudes.Presentations" %>
                ...
                <table style="width:100%;border-collapse: collapse;border-spacing: 0;">
                  <tr style="width:800px;vertical-align:top">
                    <td style="width:150px">
                        <p>presentation search here ?</p>
                    </td>
                    <td style="width:20px">
                    </td>
                    <td style="width:650px;vertical-align:top">
                        <div style="margin-left:10px;margin-top:10px;">
                            <p>presentation item here</p>
                        </div>
                    </td>
                    <td style="width:20px">
                    </td>
