<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MEMS.aspx.cs" Inherits="Astudes.MEMS" %>
                  ...
                  <tr style="width:800px">
                    ...
                    <td style="width:140px;vertical-align:top">
                        ...
                        <div style="margin-bottom:20px;border-left:2px solid #b2adad;padding-left:5px"> 
                            <div><a href="/Electromagnetics">Electromagnetics</a></div>
                        </div>
                        <p>Discover Astute</p>
                        <div style="margin-bottom:20px;border-left:2px solid #b2adad;padding-left:5px">
