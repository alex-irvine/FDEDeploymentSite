<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductEngineeringConsultancy.aspx.cs" Inherits="Astudes.ProductEngineeringConsultancy" %>
    ...
    <section>
        <div class="containerSpecial2" style="width:1000px !important">
            <div id="titrePage">
                ...
                <h4>Product Engineering Consultancy</h4>
            </div>
            <div>
                <table style="width:100%;border-collapse: collapse;border-spacing: 0;">
                  <tr style="width:800px;vertical-align:top">
                    <td style="width:150px">
                        <div><img src="Images/contentimg/algorithm optim.png" style="margin-top:20px;margin-bottom:30px;max-width:140px"/></div>
                        <div><img src="Images/contentimg/EM radiation.jpg" style="margin-top:25px;margin-bottom:30px;max-width:140px"/></div>
                        <div><img src="Images/contentimg/radiation.jpg" style="margin-top:25px;margin-bottom:30px;max-width:140px"/></div>
                    </td>
                    <td style="width:20px">
                    </td>
                    ...
                    <td style="width:160px;vertical-align:top">
                        ...
                        <div style="margin-bottom:20px;border-left:2px solid #b2adad;padding-left:5px"> 
                            <div><a runat="server" href="/MicrowaveAntennaPropagation">Microwave Antenna & Propagation</a></div>
                            <div><a runat="server" href="/IMicrowaveFilter">IMicrowave Filter</a></div>
                            <div><a runat="server" href="/GeneralEMDesigns">General EM Designs</a></div>
                            <div><a runat="server" href="/MEMSDesigns">MEMS Designs</a></div>
                            <div><a runat="server" href="/EfficientSimulation">Efficient Simulation - Driven Optimization</a></div>
                            <div><a runat="server" href="/SecuritySystemDesign">Security System Design</a></div>
                            <div><a runat="server" href="/ProductEngineeringConsultancy">Product Engineering Consultancy</a></div>
                        </div>
                        <p>Discover Astute</p>
                        <div style="margin-bottom:20px;border-left:2px solid #b2adad;padding-left:5px">
