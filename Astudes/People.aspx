<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="People.aspx.cs" Inherits="Astudes.People" %>
    ...
    <section>
        <div class="containerSpecial2">
            ...
            <div class="row" style="text-align:center">
                <img class="banner" src="Images/bannerPeople.jpg" />
            </div>
            <div>
                  ...
                  <tr style="width:800px">
                    <td style="width:650px;vertical-align:top">
                        <div style="margin-left:10px;margin-top:10px;">
                            <h5>People Lorem ipsum dolor sit amet</h5>
            ...
            <hr id="finArticle2" />
            <div>
                <table style="width:100%;border-collapse: collapse;border-spacing: 0;margin-top:10px;">
                    <tr style="width:800px">
                        <td style="width:650px;vertical-align:top">
                        ...
                        <td>
                            <iframe src="https://www.youtube.com/embed/ERuEmzVcTTg"></iframe>
                        </td>
                    </tr>
                </table>
            </div>
