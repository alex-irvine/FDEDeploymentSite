<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MicrowaveAntennaPropagation.aspx.cs" Inherits="Astudes.MicrowaveAntennaPropagation" %>
    ...
    <section>
        <div class="containerSpecial2" style="width:1000px !important">
            <div id="titrePage">
                ...
                <h4>Microwave Antenna & Propagation</h4>
            </div>
            <div>
                  ...
                  <tr style="width:800px;vertical-align:top">
                    ...
                    <td style="width:160px;vertical-align:top">
                        ...
                        <div style="margin-bottom:20px;border-left:2px solid #b2adad;padding-left:5px"> 
                            ...
                            <div><a runat="server" href="/MicrowaveFilter">Microwave Filter</a></div>
